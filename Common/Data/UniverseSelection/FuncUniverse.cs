...
namespace QuantConnect.Data.UniverseSelection
{
    ...
    public class FuncUniverse : Universe
    {
        ...
        /// <param name="universeSelector">Returns the symbols that should be included in the universe</param>
        public FuncUniverse(SubscriptionDataConfig configuration,
            UniverseSettings universeSettings,
            ISecurityInitializer securityInitializer,
            bool addSubscriptions,
            Func<IEnumerable<BaseData>, IEnumerable<Symbol>> universeSelector)
            : base(configuration, securityInitializer, addSubscriptions)
        {
            _universeSelector = universeSelector;
            _universeSettings = universeSettings;
        }
