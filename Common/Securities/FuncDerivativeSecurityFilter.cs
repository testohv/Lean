...
{
    /// <summary>
    /// Provides a functional implementation of the <see cref="IDerivativeSecurityFilter"/> interface
    /// </summary>
    public class FuncDerivativeSecurityFilter : IDerivativeSecurityFilter
    {
        private readonly Func<IEnumerable<Symbol>, BaseData, IEnumerable<Symbol>> _filter;

        /// <summary>
        /// Initializes a new instance of the <see cref="FuncDerivativeSecurityFilter"/> class
        /// </summary>
        /// <param name="filter">The functional implementation of the <see cref="Filter"/> method</param> 
        public FuncDerivativeSecurityFilter(Func<IEnumerable<Symbol>, BaseData, IEnumerable<Symbol>> filter)
        {
            _filter = filter;
        }
