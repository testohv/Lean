...
namespace QuantConnect.Util
{
    ...
    public static class LinqExtensions
    {
        ...
        /// <param name="enumerable">An <see cref="T:System.Collections.Generic.IEnumerable`1"/> whose elements that are not also in <paramref name="hashSet"/> will be returned.</param>
        /// <param name="hashSet">An <see cref="T:System.Collections.Generic.IEnumerable`1"/> whose elements that also occur in the first sequence will cause those elements to be removed from the returned sequence.</param>
        /// <returns>A sequence that contains the set difference of the elements of two sequences.</returns>
        public static IEnumerable<T> Except<T>(this IEnumerable<T> enumerable, HashSet<T> hashSet)
        {
            return enumerable.Where(item => !hashSet.Contains(item));
        }
